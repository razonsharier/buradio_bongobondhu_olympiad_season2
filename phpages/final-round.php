    ...
    <div id="bodycontainer">
        ...
        <div id="containbody">
            <div id="quizbody">
                ...
                <p style="<?php echo $_SESSION['step1']; ?>">
                    আপনার কুইজটি জমা নেওয়া হয়েছে।

                    <br />

                <p style="<?php echo $_SESSION['step1']; ?>;margin-top: 50px">২২শে আগস্ট ২০২১, রাত ৮টায় <a href="https://www.facebook.com/buradio.org/" target="_blank">BU RADiO</a> পেইজ থেকে লাইভ অনুষ্ঠানের মাধ্যমে ফলাফল ঘোষণা করা হবে।</p>

                </p>


                <p style="display: none;">২১শে আগস্ট ২০২১, দুপুর ৩টা থেকে ৩ঃ৩০ পর্যন্ত দ্বিতীয় রাউন্ডের কুইজে অংশগ্রহণ করা যাবে।</p>
                <div>
                    <div style="<?php echo $_SESSION['step1ini']; ?>">

                    <p>দ্বিতীয় রাউন্ডের কুইজে অংশগ্রহনের সময়সীমা শেষ হয়েছে।</p>
                    <br /><br />
