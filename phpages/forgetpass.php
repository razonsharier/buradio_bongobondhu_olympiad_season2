...
if (isset($_POST['recover'])) {
    ...
    if (!$_POST["email"]) {
        ...
        if (1 == $row) //find data into database
        {
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style='margin-left: 10px; padding-left: 10px; padding-bottom: 0px; border-bottom: 1px solid #e5e5e5;' align='left' valign='left'>
                                                                <a href='https://olympiad.buradio.org/' style='text-decoration:none' target='_blank'>
                                                                    <img alt='' border='0' src='https://olympiad.buradio.org/media/logo.jpg' style='width:auto;max-height:50px;height:auto;display:block' height='50'>
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            <td style='padding-top:10px;padding-bottom:10px' align='left' valign='top'>
                                                                                <table border='0' cellpadding='0' cellspacing='0' align='left'>
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td style='background-color: #298ac7; padding: 5px 20px; border-radius: 2px;' align='left'> <a href='https://olympiad.buradio.org/reset/{$user_id}/{$requestId}' style='color:#fff;font-family:Poppins,Helvetica,Arial,sans-serif;font-size:14px;font-weight:600;font-style:normal;letter-spacing:1px;line-height:20px;text-decoration:none;display:block' target='_blank'>Reset Password</a>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                        ...
                                                        <tr>
                                                            <td style='padding-top: 0px; padding-bottom: 5px; padding-left: 10px;' align='left' valign='top'>
                                                                ...
                                                                <a style='color:#007CC7;font-family:Helvetica,Arial,sans-serif;font-size:14px;font-weight:400;font-style:normal;letter-spacing:normal;line-height:20px;text-transform:none;text-align:center;padding:0;margin:0;text-decoration:none;' href='https://olympiad.buradio.org/reset/{$user_id}/{$requestId}' target='_blank'>https://olympiad.buradio.org/reset/{$user_id}/{$requestId}</a>
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        <tr>
            ...
            $mail->Username = "info@buradio.org";
            $mail->Password = '-r[Xna=}QB*^';
            $mail->Port = 465;
            $mail->SMTPSecure = "ssl";

            //Email Settings
            $mail->isHTML(true);
            $mail->setFrom('info@buradio.com', 'Bongobondhu Olympiad');
